...
\begin{tikzpicture}[line width=1pt]
  ...
  \draw[->,red] (0.8,0.3) -- (0.8,-1);
  \node[right] at (0.4,-1.3) {\textcolor{red}{\texttt{\textbackslash{}1}}};
  \draw[blue] (1.3,0.3) -- (1.3,-0.6);
  \draw[->,blue] (1.3,-0.6) -- (2,-0.6);
  \node[right] at (2,-0.6) {\textcolor{blue}{\texttt{\textbackslash{}2}}};
  \draw[->,PineGreen] (3.5,0.3) -- (3.5,-1);
  \node[right,PineGreen] at (3.2,-1.3) {\textcolor{PineGreen}{\texttt{\textbackslash{}3}}};
\end{tikzpicture}
