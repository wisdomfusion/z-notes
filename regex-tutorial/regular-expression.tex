...
\newcommand{\sectionbreak}{\clearpage}                         % section 换页
...
\begin{longtable}{p{4em}p{9em}p{25em}p{18em}}
  ...
  \midrule
  %--------------------
  递归 & (?R) & 递归匹配，Perl中使用 (?R) 或 (?0)，Ruby 2.0\footnote{Ruby是一门开源的动态编程语言，注重简洁和效率。重整本文档时，Ruby最新版本是 2.3.0。详见\href{http://www.ruby-lang.org/}{Ruby语言官方网站。}}中使用 \textbackslash{}g<0> & \cbregex{a(?R)?z} \\
\end{longtable}
